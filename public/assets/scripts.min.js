...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! alpinejs */ \"./node_modules/alpinejs/dist/module.esm.js\");\n/* harmony import */ var _components_Menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Menu */ \"./src/components/Menu.js\");\n/* harmony import */ var _components_GuessWho__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/GuessWho */ \"./src/components/GuessWho.js\");\n/* harmony import */ var _components_Codenames__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Codenames */ \"./src/components/Codenames.js\");\n/* harmony import */ var _characters_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./characters.json */ \"./src/characters.json\");\n/* harmony import */ var _games_guessWho_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./games/guessWho-data */ \"./src/games/guessWho-data.js\");\n/* harmony import */ var _games_guessWho_data__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_games_guessWho_data__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _games_codenames_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./games/codenames-data */ \"./src/games/codenames-data.js\");\n\n\n\n\n\n\n\n\n\nwindow.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_0__[\"default\"]\n\ncustomElements.define('gg-menu', _components_Menu__WEBPACK_IMPORTED_MODULE_1__[\"default\"])\ncustomElements.define('gg-guesswho', _components_GuessWho__WEBPACK_IMPORTED_MODULE_2__[\"default\"])\ncustomElements.define('gg-codenames', _components_Codenames__WEBPACK_IMPORTED_MODULE_3__[\"default\"])\n\nalpinejs__WEBPACK_IMPORTED_MODULE_0__[\"default\"].data('global', () => ({\n   init() {\n      console.log('By https://fagnerjb.com')\n\n      window.onbeforeunload = () => {\n         if (this.$store.current !== 'menu') {\n            return 'Are you sure?'\n         }\n      }\n\n      this.$watch('$store.game.current', (game) => {\n         if (game === 'menu') {\n            this.$store.game.setParam('game')\n         } else {\n            this.$store.game.setParam('game', game)\n         }\n\n         if (game !== 'codenames') {\n            this.$store.game.setParam('seed')\n         }\n      })\n   },\n}))\n\nalpinejs__WEBPACK_IMPORTED_MODULE_0__[\"default\"].store('game', {\n   current: 'menu',\n   characters: _characters_json__WEBPACK_IMPORTED_MODULE_4__,\n   set: '',\n   list: [],\n\n   init() {\n      const url = new URL(location.href)\n\n      if (url.searchParams.has('set')) {\n         this.setList(url.searchParams.get('set'))\n      }\n\n      if (url.searchParams.has('game')) {\n         this.current = url.searchParams.get('game')\n      }\n   },\n\n   openSets() {\n      const sets = document.getElementById('sets')\n      sets.showModal()\n   },\n\n   closeSets() {\n      const sets = document.getElementById('sets')\n      sets.close()\n   },\n\n   setList(set = '') {\n      if (set.length === 0) {\n         set = this.set\n         this.list = []\n      }\n      this.set = set\n      setTimeout(() => {\n         this.list = this.characters[this.set].list\n      }, 1)\n      this.setParam('set', set)\n      this.closeSets()\n   },\n\n   setParam(key, value = null) {\n      const url = new URL(location.href)\n      const params = new URLSearchParams(url.search)\n\n      if (null === value) {\n         params.delete(key)\n      } else {\n         params.set(key, value)\n      }\n\n      history.replaceState(null, '', url.pathname + '?' + params.toString())\n   },\n})\n\nalpinejs__WEBPACK_IMPORTED_MODULE_0__[\"default\"].start()\n\n\n//# sourceURL=webpack://guessing-games/./src/index.js?\n}");
